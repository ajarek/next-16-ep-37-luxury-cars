...
// Dane statyczne strony — wydzielone z JSX dla czytelności.
const values = [
  {
    icon: "diamond",
...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="relative px-margin-page py-stack-lg overflow-hidden bg-surface">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-on-surface-variant text-body-md font-body-md max-w-2xl">
            Rozdajemy klucze do emocji, które trudno ubrać w słowa — do przyspieszenia,
            które wciska w fotel, do brzmienia silnika, które brzmi jak prywatna
            symfonia. LUXE AUTO to atelier rzadkich maszyn i jeszcze rzadszych opowieści.
          </p>
        </div>
      </section>
      ...
      <section className="px-margin-page py-stack-lg bg-surface-container-low">
        <div className="mb-12 max-w-2xl">
          ...
          <p className="text-on-surface-variant text-body-md font-body-md">
            Cztery zasady, których nie łamiemy — nawet gdy nikt nie patrzy. One definiują
            każdy wybór, od doboru aut po uścisk dłoni przy pożegnaniu.
          </p>
        </div>
          ...
          {values.map((value) => (
            ...
            >
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-data-lg text-data-lg mb-2">{value.title}</h3>
                  <p className="text-on-surface-variant text-body-md font-body-md">
                    {value.description}
                  </p>
                </div>
      ...
      <section className="px-margin-page py-stack-lg bg-surface">
        <div className="mb-12 max-w-2xl">
          <h2 className="font-headline-lg text-headline-lg mb-4">Droga, którą przebyliśmy</h2>
          <p className="text-on-surface-variant text-body-md font-body-md">
            Od jednoosobowego garażu po galerię, do której zjeżdża się elita europejskich
            kolekcjonerów — każda data to kamień milowy naszej obsesji.
          </p>
        </div>

        <div className="relative">
          {/* Pionowa linia osi czasu */}
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary-gold/50 via-white/10 to-transparent"></div>
          ...
          <div className="space-y-12">
            {timeline.map((item, index) => (
              ...
              >
                ...
                {/* Karta treści — naprzemiennie lewo/prawo na desktopie */}
        ...
        <div className="glass p-12 rounded-[3rem] relative overflow-hidden flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-2/3 z-10">
            <h2 className="font-display-lg text-display-lg-mobile md:text-display-lg mb-6 leading-tight">
              ...
              <br />
              <span className="text-primary-gold italic">zaczyna się tutaj.</span>
            </h2>
            <p className="text-on-surface-variant text-body-md font-body-md mb-8 max-w-xl">
              Umów prywatne oględziny w naszym atelier. Bez pośpiechu, bez tłumu — tylko
              Ty, samochód i zapach prawdziwej skóry. Czekamy z kawą i kluczykami.
            </p>
