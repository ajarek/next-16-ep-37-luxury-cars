        ...
        <div className='relative z-10 grid lg:grid-cols-2 gap-8 px-margin-page py-stack-lg items-center'>
          <div className='order-2 lg:order-1'>
            ...
            <div className='flex flex-wrap items-center gap-6'>
              <div>
                ...
                <div className='font-data-lg text-data-lg text-primary-gold'>
                  {car.price}
                </div>
              </div>
              <Link
                href={`/finalising/${car.id}`}
                className='bg-primary-gold text-on-primary-gold px-8 py-4 rounded-xl font-data-lg text-data-lg gold-glow gold-glow-hover transition-all flex items-center gap-3 group'
              >
                Kup teraz
          ...
          <div className='order-1 lg:order-2 relative'>
            <div className='relative aspect-4/3 flex items-center justify-center'>
              <span className='absolute inset-0 flex items-center justify-center font-data-lg text-[16rem] leading-none text-white/3 select-none pointer-events-none'>
                {car.monogram}
              </span>
              <Image
                src={car.image}
        ...
        <div className='grid lg:grid-cols-3 gap-gutter'>
          ...
          <div className='lg:col-span-2 space-y-6 text-on-surface-variant text-body-md font-body-md'>
            <p>
              ...
              się unikatem. To nie jest samochód z taśmy; to sygnatura czasu, w
              której materia, dźwięk i geometria spotykają się w jednym celu:
              czystej, bezkompromisowej emocji.
            </p>
            <p>
              Serce {car.badge} bije z częstotliwością, którą słychać, zanim
              zobaczysz. Moment, w którym wciśniesz pedał gazu, jest momentem, w
              którym czas się zgina — {car.acceleration} do setki to nie liczba,
              to obietnica spełniona w jednym oddechu. A gdy silnik osiągnie{" "}
              {car.topSpeed}, wiesz, że dotknąłeś krawędzi tego, co inżynieria
              pozwala cywilizacji.
            </p>
            <p>
              {car.power} mocy, ale prawdziwa siła leży w kontroli. Każdy układ
              — od aerodynamiki po dystrybucję momentu — działa w harmonii, jak
              orkiestra grająca jedną partyturę. Wynik jest tak precyzyjny, że
              granica między kierowcą a maszyną znika.
            </p>
          </div>
        </div>
      </section>
