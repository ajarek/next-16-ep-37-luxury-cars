  ...
  return (
    <section className='relative h-[921px] w-full overflow-hidden flex items-center'>
      <div className='absolute inset-0 z-0'>
        <div ref={heroRef} className='w-full h-full relative scale-105'>
          <div
      ...
      <div className='relative z-10 px-margin-page max-w-4xl'>
        ...
        <div className='flex flex-wrap gap-4'>
          <button
            ...
            className='bg-primary-gold text-on-primary-gold px-8 py-4 rounded-xl font-data-lg text-data-lg gold-glow gold-glow-hover transition-all flex items-center gap-3 group cursor-pointer'
          >
            Kolekcja
          ...
          <button
            onClick={() => router.push("/collection/9")}
            className='glass px-8 py-4 rounded-xl font-data-lg text-data-lg hover:bg-white/10 transition-all flex items-center gap-3 cursor-pointer'
          >
