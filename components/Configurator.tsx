...
const PAINTS = (accent: string): Option[] => [
  {
    id: "signature",
    label: "Sygnatura marki",
    detail: "Odcień charakterystyczny",
    price: 0,
    swatch: accent,
  },
  {
  ...
  {
    id: "graphite",
    label: "Graphite Titan",
    detail: "Metalizowany grafit",
    price: 8000,
    swatch: "#3a3a3a",
  },
  {
  ...
  },
  {
    id: "crimson",
    label: "Crimson Rosso",
    detail: "Klasyczna czerwień wyścigowa",
    price: 12000,
    swatch: "#7a0a0a",
  },
  {
    id: "bespoke",
    label: "Bespoke Gold",
    detail: "Lakier na zamówienie — ręczna aplikacja",
    price: 25000,
    swatch: "#f2ca50",
  },
]
...
const WHEELS: Option[] = [
  {
    id: "std",
    label: 'Standard 20"',
    detail: "Stopy aluminiowe, klasyczny wykończ.",
    price: 0,
  },
  {
    id: "sport",
    label: 'Sport 21"',
    detail: "Pięcioramienne, satynowe",
    price: 6000,
  },
  {
    id: "forged",
    label: 'Forged 22"',
    detail: "Kute, czarno-matowe",
    price: 18000,
  },
  {
    id: "magnesium",
    label: "Track Magnesium",
    detail: "Magnezowe, ekstremalnie lekkie",
    price: 35000,
  },
]
...
const INTERIORS: Option[] = [
  {
    id: "nappa",
    label: "Nappa — Onyx",
    detail: "Czarna skóra Nappa",
    price: 0,
    swatch: "#1a1a1a",
  },
  {
    id: "alcantara",
    label: "Alcantara — Carbon",
    detail: "Mikrozamsz z akcentami włókna",
    price: 8000,
    swatch: "#262626",
  },
  {
    id: "semi",
    label: "Semi-Aniline — Saddle",
    detail: "Skóra półanilinowa, koniak",
    price: 22000,
    swatch: "#7a4a1f",
  },
  {
    id: "bespoke",
    label: "Bespoke Quilted — Cream",
    detail: "Pikowana, kremowa, ręczne szycie",
    price: 40000,
    swatch: "#d9c9a8",
  },
]
...
const PACKAGES: Pkg[] = [
  {
    id: "carbon",
    label: "Pakiet Carbon",
    detail: "Aerodynamika i detale z włókna węglowego",
    icon: "air",
    price: 45000,
  },
  {
    id: "exhaust",
    label: "Sport Exhaust",
    detail: "Tytonowy dźwięk, regulowany wydech",
    icon: "graphic_eq",
    price: 12000,
  },
  {
    ...
    detail: "System audio 1500W, 22 głośniki",
    icon: "speaker",
    price: 18000,
  },
  {
    ...
    detail: "Telemetria torowa i rejestrator danych",
    icon: "analytics",
    price: 9000,
  },
  {
    ...
    detail: "Karbidowo-ceramiczne tarcze, odporniejsze na fading",
    icon: "disc_full",
    price: 28000,
  },
  {
    id: "ppf",
    label: "Powłoka ochronna PPF",
    detail: "Niewidzialna folia chroniąca lakier",
    icon: "shield",
    price: 15000,
  },
]
...
const DELIVERY: Option[] = [
  {
    ...
    detail: "Osobiście, z ceremonią przekazania",
    price: 0,
  },
  {
    id: "home",
    label: "Dostawa do domu",
    detail: "Zamknięty transport w całej Polsce",
    price: 2500,
  },
  {
    id: "concierge",
    label: "Concierge VIP",
    detail: "Biała rękawiczka, indywidualny konsjerż",
    price: 8000,
  },
]
        ...
        <div className='glass rounded-4xl p-10 text-center relative overflow-hidden gold-glow'>
          ...
          <div className='relative z-10'>
            ...
            <p className='text-on-surface-variant text-body-md font-body-md mb-2'>
              ...
              trafił do manufaktury.
            </p>
            <p className='text-on-surface-variant text-body-md font-body-md mb-8'>
              Konsjerż skontaktuje się w ciągu 24 godzin, by potwierdzić każdy
              detal.
            </p>
                          ...
                          <div className='flex items-center justify-between gap-3'>
                            ...
                            <span
                              className={`material-symbols-outlined transition-transform ${
                                on
                                  ? "text-primary-gold rotate-0"
                                  : "text-on-surface-variant rotate-45"
                              }`}
                            >
        ...
        <aside className='lg:sticky lg:top-24 h-fit'>
          <div className='glass rounded-4xl p-glass-padding relative overflow-hidden'>
            ...
            <div className='relative z-10 space-y-3 mb-6'>
              ...
              <LineItem
                label={`Lakier · ${paint.label}`}
                value={paint.price ? `+${formatUSD(paint.price)}` : "W cenie"}
              />
              <LineItem
                label={`Felgi · ${wheel.label}`}
                value={wheel.price ? `+${formatUSD(wheel.price)}` : "W cenie"}
              />
              <LineItem
                label={`Wnętrze · ${interior.label}`}
                value={
                  interior.price ? `+${formatUSD(interior.price)}` : "W cenie"
                }
              />
              {selectedPkgs.map((p) => (
                <LineItem
                  key={p.id}
                  label={`Pakiet · ${p.label}`}
                  value={`+${formatUSD(p.price)}`}
                />
              ))}
              <LineItem
                label={`Odbiór · ${delivery.label}`}
                value={
                  delivery.price ? `+${formatUSD(delivery.price)}` : "W cenie"
                }
              />
            </div>
            ...
            <button
              onClick={() => {
                setReservation(
                  `LUXE-${car.monogram}-${Math.floor(Math.random() * 9000 + 1000)}`,
                )
                setPlaced(true)
              }}
