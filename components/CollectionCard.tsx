    ...
    >
      ...
      <div className='p-glass-padding'>
        <div className='flex justify-between items-start mb-4'>
          <div>
            <h3 className='font-data-lg text-data-lg leading-none'>
              {car.name}
            </h3>
          ...
          <Link
            ...
            className='w-10 h-10 rounded-full border border-primary-gold/30 flex items-center justify-center text-primary-gold group-hover:bg-primary-gold group-hover:text-on-primary-gold transition-all'
          >
