    ...
    return (
      <div className='glass rounded-4xl p-glass-padding text-center relative overflow-hidden gold-glow'>
        ...
        <div className='relative z-10'>
          ...
          <h3 className='font-display-lg text-display-lg mb-3'>Dziękujemy</h3>
          <p className='text-on-surface-variant text-body-md font-body-md mb-6 max-w-md mx-auto'>
            ...
            w ciągu <span className='text-primary-gold'>24 godzin</span> —
      ...
      <div className='relative z-10 space-y-6'>
        ...
        >
          ...
          <span className='text-label-sm font-label-sm text-on-surface-variant'>
            Wyrażam zgodę na przetwarzanie moich danych osobowych przez LUXE
            AUTO w celu odpowiedzi na to zapytanie, zgodnie z polityką
            prywatności.
          </span>
        </button>
